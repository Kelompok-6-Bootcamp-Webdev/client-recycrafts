  ...
  return (
    <>
      <img src="assets/image/rectangle-hero.svg" alt="bg"
        className="absolute -z-10 top-0 object-contain object-left max-w-[1200px]" />
      <section className="py-20 px-5 max-w-7xl mx-auto relative">
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="pt-5 text-black w-[400px] text-justify">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
